...
export default {
  ...
  computed: {
    rotatorStyle() {
      return `transform: translate3d(${this.shift}) rotate(${this.deg}deg) scale(${this.scale}); opacity: ${
        1 - (1 - oF) * this.reverse
      }`;
    },
  },
...
.sq-rotator {
  ...
  &.glow {
    box-shadow: 0 0 33px 6px rgba(78, 227, 254, 0.431), 0 0 6px 0px rgba(78, 227, 254, 0.549), inset 0 0 20px 5px rgba(78, 227, 254, 0.431), inset 0 0 8px 0px rgba(78, 227, 254, 0.549);
  }
}
</style>
